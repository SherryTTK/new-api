...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		sandboxSelfRoute.Use(middleware.CORS(), middleware.SandboxTokenAuthReadOnly())
		{
			...
			sandboxSelfRoute.GET("/log/self", controller.GetSandboxLogSelf)
		}
		...
		logRoute.GET("/export/summary", middleware.UserAuth(), controller.ExportLogSummary)
		logRoute.GET("/export/detail", middleware.UserAuth(), controller.ExportLogDetail)
		logRoute.GET("/request", controller.GetLogByRequestId)
		...
		logRoute.Use(middleware.CORS(), middleware.CriticalRateLimit())
		{
			...
			logRoute.GET("/token/query", middleware.TokenAuthReadOnly(), controller.QueryLogByToken)
		}
